        ...
        <div className="w-64 h-screen bg-gray-900 text-white flex flex-col shadow-2xl sidebar-transition">
            ...
            <div className="p-4 border-t border-gray-800">
                <div className="flex items-center space-x-3 px-4 py-3 bg-gray-800/50 rounded-xl mb-2">
                    ...
                    <div>
                        <p className="text-sm font-semibold text-white">{userInfo.name || 'Admin'}</p>
                        <p className="text-xs text-gray-400 truncate max-w-[120px]" title={userInfo.email}>{userInfo.email || 'admin@system.com'}</p>
                    </div>
                </div>
            </div>
        </div>
